...
public abstract class CodecUtil {
     ...
     * a wrapping String and {@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING}, i.e.
     * <p/>
     * <code>toBytes( new String(chars), {@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING} );</code>
     *
    ...
    /**
     * Converts the specified byte array to a string using JSecurity's {@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING}.
     *
     * @param bytes the byte array to turn into a String.
     * @return the specified byte array as an encoded String ({@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING}).
     */
    ...
    /**
     * Returns the specified byte array as a character array using JSecurity's {@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING}.
     *
     * @param bytes the byte array to convert to a char array
     * @return the specified byte array encoded as a character array ({@link CodecUtil#PREFERRED_ENCODING PREFERRED_ENCODING}).
     */
